              ...
              <div className="w-full px-4 md:w-1/2">
                <div className="lg:pl-20">
                        ...
                        <li>
                          <a href="#">
                            <svg
                              ...
                              height="16"
                              fill="currentColor"
                              className="w-4 mr-1 text-sky-500 dark:text-gray-400 bi bi-star "
                              viewBox="0 0 16 16"
                            >
                  ...
                  <div className="flex flex-wrap items-center mb-6">
                    ...
                    <a
                      href="#"
                      className="w-full px-4 py-3 text-center text-sky-600 bg-sky-100 border border-sky-600 dark:hover:bg-gray-900 dark:text-gray-400 dark:border-gray-700 dark:bg-gray-700 hover:bg-sky-600 hover:text-gray-100 lg:w-1/2 rounded-xl"
                    >
                      Add to cart
                    </a>
                  </div>
